...
class Recoleccion {
  ...
  //int idMunicipioRecibe;

  // int idDireccionClienteEnvia;
  Municipio municipioRecibe;

  Cliente clienteEnvia;
  // Direccion direccionEnvia;
  //Municipio municipioEnvia;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'estado': estado,
      'tipoPago': tipoPago,
      //'idMunicipioRecibe': idMunicipioRecibe,
      'municipioRecibe': municipioRecibe.toMap(),
      //'idClienteEnvia': idClienteEnvia,
      'clienteEnvia': clienteEnvia.toMap(),
      //'idDireccionClienteEnvia': idDireccionClienteEnvia,
      //  'direccionClienteEnvia': direccionEnvia.toMap(),
      //  'municipioEnvia': municipioEnvia.toMap()
    };
  }
